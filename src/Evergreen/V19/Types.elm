...
import Effect.Time
import Evergreen.V19.I18n
import Evergreen.V19.Theme
import Evergreen.V19.Tutorial.Types
import Random
import Url
...
type alias LocalStorage =
    { language : Evergreen.V19.I18n.Language
    , darkMode : Evergreen.V19.Theme.DarkOrLight
    }
...
type alias FrontendModel =
    ...
    , tutorialState : Maybe Evergreen.V19.Tutorial.Types.TutorialStep
...
type FrontendMsg
    ...
    | CancelBotDifficulty
    | PlayForMe
    | ChangeLanguage Evergreen.V19.I18n.Language
    | CloseDebugger
    | UndoMove
    | RedoMove
    | ToggleDarkMode
