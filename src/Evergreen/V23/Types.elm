...
import Effect.Time
import Evergreen.V23.I18n
import Evergreen.V23.Theme
import Evergreen.V23.Tutorial.Types
import Random
import Url
...
type alias LocalStorage =
    { language : Evergreen.V23.I18n.Language
    , userPreference : Evergreen.V23.Theme.UserPreference
    , systemMode : Evergreen.V23.Theme.Mode
    }
...
type alias FrontendModel =
    ...
    , board : BigBoard
    , route : Route
    , language : Maybe Evergreen.V23.I18n.Language
    , userPreference : Evergreen.V23.Theme.UserPreference
    , systemMode : Evergreen.V23.Theme.Mode
    ...
    , tutorialState : Maybe Evergreen.V23.Tutorial.Types.TutorialStep
...
type FrontendMsg
    ...
    | CancelBotDifficulty
    | PlayForMe
    | ChangeLanguage Evergreen.V23.I18n.Language
    | CloseDebugger
    | UndoMove
    | RedoMove
    | ToggleDarkMode
